...
class Hxl:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&HXL')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'Hxl')
        self.toolbar.setObjectName(u'Hxl')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Hxl', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Hxl/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'HXL'),
            callback=self.run,
